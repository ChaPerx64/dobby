			...
			case 'm': // Prefix: "me"
				...
				case '/': // Prefix: "/allocations"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "GET":
							s.handleGetCurrentUserAllocationsRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, "GET")
						}
			...
			case 'm': // Prefix: "me"
				...
				case '/': // Prefix: "/allocations"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "GET":
							r.name = GetCurrentUserAllocationsOperation
							r.summary = "Get current user's allocation for current period"
							r.operationID = "getCurrentUserAllocations"
							r.operationGroup = ""
							r.pathPattern = "/me/allocations"
							r.args = args
							r.count = 0
							return r, true
						default:
